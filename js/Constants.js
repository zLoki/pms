var Constants = {
    ...
    Item: {
        Item_11: {id: 11, name: "Create migration to create folders for opportunity phases", description: "", min: 4, max: 8, likely: 8, weighted_avg: null, isCompleted: "0", assignedTo: ""},
        Item_12: {id: 12, name: "Create migration to move Checklist items folders to corresponding Opportunity phase", description: "", min: 8, max: 24, likely: 16, weighted_avg: null, isCompleted: "0", assignedTo: ""},
        Item_13: {id: 13, name: "Update Opportunity creation functionality to create Opportunity phases folders", description: "", min: 4, max: 6, likely: 5, weighted_avg: null, isCompleted: "0", assignedTo: ""},
        Item_14: {id: 14, name: "Update Checklist item creation functionality to create folder for current checklist item", description: "", min: 4, max: 6, likely: 5, weighted_avg: null, isCompleted: "0", assignedTo: ""},
        Item_15: {id: 15, name: "Check File Manager to work with new Opportunity folders structure", description: "", min: 2, max: 4, likely: 4, weighted_avg: null, isCompleted: "0", assignedTo: ""},
        Item_16: {id: 16, name: "Disable Checklist item attached file deletion, locked on File Manager", description: "", min: 3, max: 6, likely: 6, weighted_avg: null, isCompleted: "0", assignedTo: ""},
        Item_17: {id: 17, name: "Non-functional (Testing, Code review, Demo preparation)", description: "", min: 6, max: 12, likely: 8, weighted_avg: null, isCompleted: "0", assignedTo: ""},
        Item_21: {id: null, name: "", description: "", min: "", max: "", likely: "", weighted_avg: null, isCompleted: "0", assignedTo: ""},
        Item_22: {id: null, name: "", description: "", min: "", max: "", likely: "", weighted_avg: null, isCompleted: "0", assignedTo: ""},
        Item_23: {id: null, name: "", description: "", min: "", max: "", likely: "", weighted_avg: null, isCompleted: "0", assignedTo: ""},
        Item_24: {id: null, name: "", description: "", min: "", max: "", likely: "", weighted_avg: null, isCompleted: "0", assignedTo: ""}
    },
