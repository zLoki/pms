    ...
    blkUI.factory('blockUIHttpInterceptor', ["$q", "$injector", "blockUIConfig", function($q, $injector, blockUIConfig) {
        ...
        return {
            ...
            response: function(response) {
                if (!angular.isObject(response)) return response;
    ...
    blkUI.factory('blockUI', ["blockUIConfig", "$timeout", "blockUIUtils", "$document", function(blockUIConfig, $timeout, blockUIUtils, $document) {
        ...
        function BlockUI(id) {
            ...
            this.start = function(message) {
                ...
                state.message = message ? message.trim() : message;
            ...
            this.useDefaultCursor = function(value) {
                state.defaultCursor = value;
            };
...
// manually in the index.html. This file is only here for your debugging pleasures.
    angular.module('blockUI').run(['$templateCache', function($templateCache){
        $templateCache.put('angular-block-ui/angular-block-ui.ng.html', '<div ng-show=\"state.blockCount > 0\" class=\"block-ui-overlay\" ng-class=\"{ \'block-ui-visible\': state.blocking && !state.defaultCursor,  \'block-ui-visible-default-cursor\': state.blocking && state.defaultCursor }\"></div><div ng-show=\"state.blocking\" class=\"block-ui-message-container\" aria-live=\"assertive\" aria-atomic=\"true\"><div ng-show=\"state.message\" class=\"block-ui-message\">{{ state.message }}</div></div>');
    }]);
})(angular);
